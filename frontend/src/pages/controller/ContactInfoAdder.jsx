...
import ContactInfoForm from "../../Forms/ContactsInfoForm";
  ...
  return (
    <>
      ...
      <div className="flex flex-row bg-gray-700 m-3" >
        <div className=" w-[20%] bg-gray-200 h-[500px]">
            ...
            <div className="bg-blue-100 p-5 m-5">
              ...
              <div className="w-full bg-white p-2 md:p-5 mt-5 shadow-lg flex items-center justify-between">
                ...
                <div className="bg-red-600 text-white font-bold text-base md:text-2xl p-2 rounded-md">
                  ...
                  <button type="submit" onClick={""} className="bg-ControllerSec w-[10%] rounded-lg items-center justify-center focus:ring-4 focus:outline-none hover:bg-[gray] shadow-md shadow-[gray] py-2 px-1 text-white font-semibold text-xl text-center text-[1.2rem]">
                      Edit
                  </button>
              </div>

...
const Weather =() => {
    ...
    return(
        <div className='w-full h-full text-white text-[0.8rem] bg-cover bg-center bg-[url("../../controller/weatherbg2.jpg")] '>
            ...
            <div className='flex justify-center mt-5 mb-0 '>
              <div className='grid grid-cols-1 relative items-center p-5 pb-0 rounded-[1rem] justify-center md:grid-cols-2 gap-2  h-full bg-transparent '>
                 <div className='flex  bg-transparent flex-col p-5 m-10 m-1 md:m-5 rounded-[1rem] justify-center   items-center content-center  '>
                    <img src={`http://openweathermap.org/img/wn/${weatherData.current.weather[0].icon}.png`} alt='' className=' rounded-[50%]  bg-secondary justify-center w-32 h-32'/>
                ...
                <div className='flex flex-col py-5 pb-0 rounded-[1rem] bg-transparent backdrop-blur-md shadow-2xl shadow-white'> 
        ...
        {forecast && (
          ...
          <div className="grid grid-cols-7 my-5 pb-5 px-5 ">
            {forecast.slice(1 ,8).map((day, index) => (
              <div key={index} className=' pt-2 p-2 bg-transparent backdrop-blur-lg rounded-[1rem] m-1'>
                ...
                <div className='grid grid-cols-1 flex gap-1 p-1 w-full justify-center p-3 shadow-sm rounded-md bg-transparent items-center hover:bg-[#4d4c4c] transition duration-200 ease-linear hover:shadow-white'>
                    <img src={`http://openweathermap.org/img/wn/${day.weather[0].icon}.png`} alt='' className=' rounded-[50%]  bg-secondary w-25 h-25'/>
